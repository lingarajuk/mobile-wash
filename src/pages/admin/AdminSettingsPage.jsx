...
import { INITIAL_BUSINESS_SETTINGS } from '../../data/mockData';
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-16">
      <div>
        ...
        <p className="text-xs text-slate-400">Configure company branding, operating hours and tax policies</p>
      </div>

      <form onSubmit={handleSave} className="glass-card p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-4 shadow-xl">
        ...
        <div>
          <label className="text-xs font-semibold text-slate-300 block mb-1">Business Headquarter Address</label>
          <textarea
        ...
        <div>
          <label className="text-xs font-semibold text-slate-300 block mb-1">Active Service Areas (Comma Separated)</label>
          <textarea
        ...
        <div>
          <label className="text-xs font-semibold text-slate-300 block mb-1">Cancellation & Refund Policy</label>
          <textarea
